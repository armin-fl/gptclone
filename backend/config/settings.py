...
VLLM_SWITCH_SLEEP_LEVEL = int(os.environ.get("VLLM_SWITCH_SLEEP_LEVEL", str(VLLM_SLEEP_LEVEL)))
VLLM_WARMUP_SLEEP_LEVEL = int(os.environ.get("VLLM_WARMUP_SLEEP_LEVEL", str(VLLM_SWITCH_SLEEP_LEVEL)))
